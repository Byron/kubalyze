...
pub struct PodSecurityPolicySpec {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub allowed_flex_volumes: Option<Vec<::api::policy::v1beta1::AllowedFlexVolume>>,

    /// is a white list of allowed host paths. Empty indicates that all host paths may be used.
    #[serde(rename = "allowedHostPaths")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub allowed_host_paths: Option<Vec<::api::policy::v1beta1::AllowedHostPath>>,
    ...
    pub fs_group: ::api::policy::v1beta1::FSGroupStrategyOptions,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub host_ports: Option<Vec<::api::policy::v1beta1::HostPortRange>>,
    ...
    pub run_as_user: ::api::policy::v1beta1::RunAsUserStrategyOptions,

    /// seLinux is the strategy that will dictate the allowable labels that may be set.
    #[serde(rename = "seLinux")]
    pub se_linux: ::api::policy::v1beta1::SELinuxStrategyOptions,

    /// SupplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    #[serde(rename = "supplementalGroups")]
    pub supplemental_groups: ::api::policy::v1beta1::SupplementalGroupsStrategyOptions,
